...
#endif
static const char *ng0 = "C:/Users/justi_000/Dropbox/Justin/Academia/Current Courses/Digital/Exp5sch/schematicTest.v";
static int ng1[] = {0, 0};
static int ng2[] = {16, 0};
static int ng3[] = {3, 0};
static int ng4[] = {7, 0};
...
static int ng7[] = {15, 0};
static int ng8[] = {1, 0};
static const char *ng9 = "Min term bad";
static const char *ng10 = "Max term bad";
...
LAB103:
LAB104:
LAB88:    xsi_set_current_line(37, ng0);
    t2 = (t0 + 1448);
    t3 = (t2 + 56U);
    t8 = *((char **)t3);
    t9 = ((char*)((ng8)));
    memset(t15, 0, 8);
    xsi_vlog_unsigned_add(t15, 32, t8, 4, t9, 32);
    t10 = (t0 + 1448);
    xsi_vlogvar_assign_value(t10, t15, 0, 0, 4);
    t2 = (t0 + 4280);
    t7 = *((int *)t2);
    *((int *)t2) = (t7 - 1);
    goto LAB5;
...
LAB102:    xsi_set_current_line(33, ng0);

LAB105:    xsi_set_current_line(34, ng0);
...
extern void work_m_00000000003216572192_0540155903_init()
{
	static char *pe[] = {(void *)Initial_21_0};
	xsi_register_didat("work_m_00000000003216572192_0540155903", "isim/schematic_schematic_sch_tb_isim_beh.exe.sim/work/m_00000000003216572192_0540155903.didat");
